...
public class Planning {
	...
	@JsonPropertyDescription("The rationale for the procurement provided in free text. More detail can be provided in an attached document.")
	 ...
	 */
	@JsonProperty("budget")
	@JsonPropertyDescription("This section contain information about the budget line, and associated projects, through which this contracting process is funded. It draws upon data model of the [Fiscal Data Package](http://fiscal.dataprotocols.org/), and should be used to cross-reference to more detailed information held using a Budget Data Package, or, where no linked Budget Data Package is available, to provide enough information to allow a user to manually or automatically cross-reference with another published source of budget and project information.")
	...
	public String toString() {
		return new ToStringBuilder(this).append("rationale", rationale).append("budget", budget).append("documents", documents).append("milestones", milestones).toString();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(milestones).append(rationale).append(documents).append(budget).toHashCode();
	}
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(milestones, rhs.milestones).append(rationale, rhs.rationale).append(documents, rhs.documents).append(budget, rhs.budget).isEquals();
	}
