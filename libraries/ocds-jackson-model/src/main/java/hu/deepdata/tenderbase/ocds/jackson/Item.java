...
public class Item {
	 ...
	 */
	@JsonProperty("id")
	@JsonPropertyDescription("A local identifier to reference and merge the items by. Must be unique within a given array of items.")
	private String id;
	/**
	 * Description
	 * <p>
	 ...
	 */
	@JsonProperty("unit")
	@JsonPropertyDescription("A description of the unit in which the supplies, services or works are provided (e.g. hours, kilograms) and the unit-price. For comparability, an established list of units can be used.  ")
	private Unit unit;
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", id).append("description", description).append("classification", classification).append("additionalClassifications", additionalClassifications).append("quantity", quantity).append("unit", unit).toString();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(additionalClassifications).append(unit).append(quantity).append(description).append(id).append(classification).toHashCode();
	}
	...
	public boolean equals(Object other) {
		...
		Item rhs = ((Item) other);
		return new EqualsBuilder().append(additionalClassifications, rhs.additionalClassifications).append(unit, rhs.unit).append(quantity, rhs.quantity).append(description, rhs.description).append(id, rhs.id).append(classification, rhs.classification).isEquals();
	}
